    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div className="medical-card">
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Last Interaction</p>
        ...
        <div className="medical-card">
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Health Signals</p>
          <h3 className="text-xl font-bold text-slate-900">Stable</h3>
        </div>
        ...
        <div className="medical-card bg-teal-900 text-white border-none">
          ...
          <p className="text-xs font-bold text-teal-300 uppercase tracking-widest mb-1">Security</p>
          <h3 className="text-xl font-bold">AES-256 Encrypted</h3>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-xl font-bold text-slate-900">Ingestion Trends</h3>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-slate-900">Recent Vault Entries</h3>
              <button 
        ...
        <div className="space-y-8">
          {/* Health Summary Card */}
          <section className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
            <h3 className="text-lg font-bold text-slate-900 mb-6">Clinical Summary</h3>
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-slate-100">
                <div className="flex items-center justify-between mb-4">
                  <p className="text-sm font-bold text-slate-900">Vault Integrity</p>
          ...
          <section className="bg-slate-900 rounded-3xl p-8 text-white">
            <h3 className="font-bold mb-4">Emergency Access</h3>
